package com.rifcode.masvideochat.View.Login;
...
//            });
            ...
            try {
                resizedBitmapNew = ImageOrientation.modifyOrientation(AddPicActivity.this,resizedBitmap,uriImage);
            } catch (IOException e) {
                e.printStackTrace();
            }
            resizedBitmapNew.compress(Bitmap.CompressFormat.JPEG, 100, baos);
...
//            });
            ...
            try {
                ...
                //Toast.makeText(AddPicActivity.this,"Good Image.", Toast.LENGTH_SHORT).show();
                final StorageReference filePath = dataFire.getStorageref()
                        .child("all_images_user")
                        .child(dataFire.getUserID())
                        .child(getDateYears + ".jpg");
                ...
                thumb_filepath = new File(FileUtils.getPath(AddPicActivity.this, imageUri));


                Bitmap thumb_bitmap = new Compressor(AddPicActivity.this).setMaxHeight(512).setMaxWidth(512).setQuality(100).compressToBitmap(thumb_filepath);
                ByteArrayOutputStream baos = new ByteArrayOutputStream();
